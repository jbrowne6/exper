...
save(ress1, file="exp0035.Rdata")

lab <- labs(title="Per Tree Training Time vs Number of Threads", x="Number of Threads", y="Time (s)", subtitle =paste("Dataset Size: p53 (", nrow(X),"x",ncol(X),")"))
