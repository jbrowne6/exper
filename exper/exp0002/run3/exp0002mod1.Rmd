...
print(ggplot(ress2,aes(x=Cores_Used, y=Scale_Up, group=Line_Type, color=Line_Type))+geom_line()+labs(title="R-RerF Weak Scaling", x="Number of Cores", y="Relative Performance", subtitle=paste("Initial number of samples: ", baseS,"-- Ideal assumes average case complexity"))+expand_limits(y=c(0,1))+leg+Tics)
}
gc()
```
