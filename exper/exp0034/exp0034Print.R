...
load(file="exp0034.Rdata")

lab <- labs(title=paste("Median Per Tree Training Time vs\nNumber of Threads"), x="Number of Threads", y="Time (s)", subtitle =paste("Dataset Size: HIGGS (250000 x 31)"))

png(file="exp0034.png", width=pWidth, height=pHeight)
