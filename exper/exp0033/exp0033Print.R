...
load(file="exp0033.Rdata")

lab <- labs(title=paste("Median Per Tree Training Time vs\nNumber of Cores"), x="Number of Cores", y="Time (s)", subtitle =paste("Dataset Size: MNIST (60000x784)"))


png(file="exp0033.png", width=pWidth, height=pHeight)
