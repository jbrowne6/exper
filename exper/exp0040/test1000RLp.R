...
lab <- labs(title="Random Forest 1000 Trees, (R/L)can > (R/L)non", subtitle=paste("No Midkine, No Prolactin"))
png(file="RLp.png", width=pWidth, height=pHeight)
}
...
lab <- labs(title="Random Forest 1000 Trees, (R/L)can > (R/L)non", subtitle=paste("Sensitivity and Specificity as a function of Cut Val\ncut val is proportion of trees that vote cancer"))
}
...
png(file="exp0040-19.1000RLp.a.png", width=pWidth, height=pHeight)
