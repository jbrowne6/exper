...
if(rf){
lab <- labs(title="Random Forest 1000 Trees w/o m and p")
png(file="1000p.png", width=pWidth, height=pHeight)
}else{
#lab <- labs(title="Random Forest 1000 Trees, (R/S)can > (R/S)non")
...
png(file="exp0040-19.1000.a.png", width=pWidth, height=pHeight)
